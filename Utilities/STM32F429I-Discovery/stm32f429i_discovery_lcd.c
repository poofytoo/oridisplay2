...
{ 
  ...
  LTDC_InitStruct.LTDC_HorizontalSync = 1;//9;
  /* Configure vertical synchronization height */
  LTDC_InitStruct.LTDC_VerticalSync = 9;//1;
  /* Configure accumulated horizontal back porch */
  LTDC_InitStruct.LTDC_AccumulatedHBP = 3;//29; 
  /* Configure accumulated vertical back porch */
  LTDC_InitStruct.LTDC_AccumulatedVBP = 29;//3;  
  /* Configure accumulated active width */  
  LTDC_InitStruct.LTDC_AccumulatedActiveW = 323;//269;
  /* Configure accumulated active height */
  LTDC_InitStruct.LTDC_AccumulatedActiveH = 269;//323;
  /* Configure total width */
  LTDC_InitStruct.LTDC_TotalWidth = 327;//279; 
  /* Configure total height */
  LTDC_InitStruct.LTDC_TotalHeigh = 279;//327;
...
void LCD_LayerInit(void)
{
  ...
  LTDC_Layer_InitStruct.LTDC_HorizontalStart = 4; //30;
  LTDC_Layer_InitStruct.LTDC_HorizontalStop = (LCD_PIXEL_WIDTH + 4 - 1);//30 - 1); 
  LTDC_Layer_InitStruct.LTDC_VerticalStart = 30; // 4;
  LTDC_Layer_InitStruct.LTDC_VerticalStop = (LCD_PIXEL_HEIGHT + 30 - 1);//4 - 1);
